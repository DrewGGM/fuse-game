...
| 5 | **`<access origin="*" />`** | Cordova whitelist wide open in a generated compatibility file. Inert today, load-bearing the day a Cordova plugin is added | Scoped to the app's own API host |
